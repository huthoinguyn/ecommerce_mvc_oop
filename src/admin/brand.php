...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertCat = $cat->insert_brand($brandName, $state);
}
?>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <a href="brandedit.php?brandId=<?= $ct['id'] ?>">Edit</a> || <a onclick="return confirm('Are you sure to delete?')" href="?brandId=<?= $ct['id'] ?>">Delete</a>
                                        </td>
