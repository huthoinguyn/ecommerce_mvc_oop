...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertCat = $cat->insert_category($catName, $state);
}
?>
    ...
    <form action="category.php" method="POST" class="flex flex-col px-20 py-4">
        ...
        <div class="group w-72 md:w-80 lg:w-96">
            ...
            <div class="group relative w-72 md:w-80 lg:w-96">
                ...
                <input id="2" type="text" name="catName" class="peer h-10 w-full rounded-md bg-gray-50 px-4 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:bg-white focus:ring-2 focus:ring-blue-400" />
