...
class Upload
{
    ...
    public function __construct($file, $target_directory = '')
    {
        ...
        if (empty($target_directory)) {
            ...
            $this->target_directory = 'src/uploads/' . $current_month_year . '/';
    ...
    private function validateFile()
    {
        if ($this->file["size"] > $this->max_file_size) {
            $this->errors = "Kích thước tệp quá lớn, tối đa là " . $this->max_file_size / 1024 . "MB.";
        }
    ...
    private function saveInformationFile()
    {
    }
}
