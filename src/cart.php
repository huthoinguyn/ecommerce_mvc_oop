<div class="hidden w-full h-full  bg-black  bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0 z-50" id="check-div">
    <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
    <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-full transition ease-in-out duration-700" id="checkout">
        <div class="flex items-end lg:flex-row flex-col justify-end" id="cart">
            <div class="lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white overflow-y-hidden overflow-x-hidden lg:h-screen h-auto" id="scroll">
                <div class="flex items-center text-gray-500 hover:text-gray-600  cursor-pointer" onclick="checkoutHandler(true)">
                    ...
                    <p class="text-sm pl-2 leading-none hover:text-gray-200">Back</p>
                </div>
                <p class="lg:text-4xl text-3xl font-black leading-10 text-gray-800  pt-3">Bag</p>
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50 overflow-y-auto overflow-x-hidden">
                    ...
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        ...
                        <div class="flex items-center justify-between w-full pt-1">
                            ...
                            <select aria-label="Select quantity" class="py-2 px-1 border border-gray-200 mr-6 focus:outline-none bg-gray-800 hover:bg-gray-700 text-white">
                                <option>01</option>
                                <option>02</option>
                                <option>03</option>
                            </select>
                ...
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                    ...
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        <p class="text-xs leading-3 text-gray-800 md:pt-0 pt-4">RF293</p>
                        <div class="flex items-center justify-between w-full pt-1">
                            <p class="text-base font-black leading-none text-gray-800 ">LW sneakers</p>
                            <select aria-label="Select quantity" class="py-2 px-1 border border-gray-200 mr-6 focus:outline-none bg-gray-800 hover:bg-gray-700 text-white">
                                <option>01</option>
                                <option>02</option>
                                <option>03</option>
                ...
                <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                    <div>
                        ...
                        <div class="flex items-center justify-between pt-16">
                            ...
                            <p class="text-base leading-none text-gray-800 ">,000</p>
                        </div>
                        <div class="flex items-center justify-between pt-5">
                    ...
                    <div>
                        <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                            ...
                            <p class="text-2xl font-bold leading-normal text-right text-gray-800 ">,240</p>
                        </div>
                        <button onclick="checkoutHandler1(true)" class="text-base leading-none w-full py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white hover:bg-gray-700">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    let checdiv = document.getElementById("check-div");
    // let flag3 = false;
