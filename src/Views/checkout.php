...
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    ...
    <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
        ...
        <div class="">
            ...
            <div class="relative">
                <input type="text" id="email" name="email" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="<?= $_SESSION['user'][0]['email'] ?>" placeholder="your.email@gmail.com" />
            ...
            <div class="relative">
                <input type="text" value="<?= $_SESSION['user'][0]['name'] ?>" id="card-holder" name="card-holder" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Your full name here" />
                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
