...
<section>
    ...
    ?>
            <form action="/admin/updatebrand" method="POST" class="flex flex-col px-20 py-4">
                ...
                <div class="group w-72 md:w-80 lg:w-96">
                    ...
                    <div class="group relative w-72 md:w-80 lg:w-96">
                        ...
                        <input id="2" type="text" value="<?= $br['name'] ?>" name="brandName" class="peer h-10 w-full rounded-md bg-gray-50 px-4 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:bg-white focus:ring-2 focus:ring-blue-400" />
                        ...
                        <div class="flex items-start space-x-3 pt-6 pb-4">
                            <input type="checkbox" <?= $br['state'] == 1 ? "checked" : "" ?> name="state" class="border-gray-300 rounded h-5 w-5" />
